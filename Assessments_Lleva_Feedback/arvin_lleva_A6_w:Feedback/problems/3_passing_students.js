...
function scoreAvg(student) { // this helper function gets the average score per student
  ...
  } // grat job keying into the object - MS
...
function passingStudents(students) {
  ...
  for (var i = 0; i < students.length; i++) { // we iterate through student objects array
    ...
    // good job naming all these variables, it makes your code very readable - MS
...
// Once again, excellent job, great comments, grat use of a helper function - MS
