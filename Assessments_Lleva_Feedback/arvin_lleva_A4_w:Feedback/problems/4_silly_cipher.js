...
function sillyCipher(sentence, cipher){ // Everything in this function is indented once too far. -RM
  ...
  for (var i = 0; i < sentence.length; i++) {
    ...
    if (charKey !== undefined) { // we check if the character has a key value in the cipher object
      ...
      string += "." // Missing a semicolon here. // if not, we concatenate "."
    }
  }
...
// Nice job on this one, just some minor styling issues to iron out. -RM
