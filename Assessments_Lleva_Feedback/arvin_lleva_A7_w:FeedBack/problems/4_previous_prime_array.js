...
} // good second helper function - MS
...
function previousPrimeArray(array) {
  ...
  for (var i = 0; i < array.length; i++) { // we iterate though each number
    ...
    if (isPrime(num)) { // if the current number is prime
      ...
      // good job using the helper functions here - MS
...
// Great job on this solution. Great job using the helper functions to make a complex
// problem into some simple solutions - MS
